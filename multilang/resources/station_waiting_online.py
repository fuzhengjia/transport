...
class Station_flow_Waiting_Pred(object):
    ...
    def __init__(self, _station_id):
        ...
        scaler_file_name = "/home/nfs/data/metro-station-waiting/"+station_id+"/"+station_id+"_station_waiting_scaler.csv"
        model_file_name = "/home/nfs/data/metro-station-waiting/"+station_id+"/"+station_id+"_station_waiting_model.hdf5"
    ...
    def inverse_normalizating_data(self, norm_result):
        value_station_waiting_up = self.inverse_normalization(self.min_max_scaler,"label_station_waiting_up", norm_result[0])
        value_station_waiting_down = self.inverse_normalization(self.min_max_scaler,"label_station_waiting_down", norm_result[1])
