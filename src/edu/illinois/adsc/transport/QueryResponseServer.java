 ...
 */
public class QueryResponseServer implements QueryService.Iface {


    public static QueryService.Processor processor;
...
//        return -1;
    ...
    public static void main (String[] args) {
        try {
            QueryResponseServer queryResponseServer = new QueryResponseServer();
            processor = new QueryService.Processor(queryResponseServer);
